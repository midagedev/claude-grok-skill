...
# cmd/outsource and internal/grok-run. Generated by build.sh — do not edit.
#
...
# cannot execute a binary. For a fork-free call, invoke: outsource grok-run ...
exec "$(dirname "${BASH_SOURCE[0]}")/outsource" grok-run "$@"
