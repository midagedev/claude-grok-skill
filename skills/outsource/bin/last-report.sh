...
# cmd/outsource and internal/last-report. Generated by build.sh — do not edit.
#
...
# cannot execute a binary. For a fork-free call, invoke: outsource last-report ...
exec "$(dirname "${BASH_SOURCE[0]}")/outsource" last-report "$@"
