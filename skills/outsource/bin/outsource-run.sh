...
# cmd/outsource and internal/outsource-run. Generated by build.sh — do not edit.
#
...
# cannot execute a binary. For a fork-free call, invoke: outsource outsource-run ...
exec "$(dirname "${BASH_SOURCE[0]}")/outsource" outsource-run "$@"
