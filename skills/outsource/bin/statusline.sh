...
# cmd/outsource and internal/statusline. Generated by build.sh — do not edit.
#
...
# cannot execute a binary. For a fork-free call, invoke: outsource statusline ...
exec "$(dirname "${BASH_SOURCE[0]}")/outsource" statusline "$@"
